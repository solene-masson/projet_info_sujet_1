...
data = pd.read_excel(r'C:\Users\sosop\OneDrive\Documents\EIVP\Algo\projet_info\EIVP_KM_V3.xlsx')
...
def anomalies():
    ...
    if (numero in ['1','2','3','4','5','6'])==True:
        ...
        t = date_min
        delta = pd.Timedelta( hours = 20 ) #Solène tu peux changer en hours = ... ou minutes =...
        anomalies = []
        points_anomalies = []
        max_jour = []
        min_jour = []
